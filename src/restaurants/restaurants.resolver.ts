...
export class CategoryResolver {
  ...
  //Pb:Comment savoir dans quel categorie nous devons compter le nombre de restaurant.
  //  C-a-d dans chaque categorie a un nombre total de restaurant
  // Solution: @Parent va me donner la categorie en cours de traitement
