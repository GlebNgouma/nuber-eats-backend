...
export class OrdersResolver {
  ...
  //pas besoin de filtrage car le livreur doit voir toutes les commandes
  @Subscription((returns) => Order)
  @Role(['Delivery'])
  cookedOrders() {
  ...
  @Subscription((returns) => Order, {
    filter: (
      { orderUpdates: order }: { orderUpdates: Order }, //ceci est notre commande
      { input }: { input: OrderUpdatesInput },
      { user }: { user: User }, //c'est le user qui demande l'abonnement
    ) => {
      if (
